...
# Update composer
# ========================================
echo "🔧 [6/10] Menyesuaikan platform PHP di composer.json..."
sed -i 's/"php": "8\.0\.2"/"php": "8.3.23"/' composer.json

echo "📦 [7/10] Install dependensi..."
if ! command -v composer &> /dev/null; then
    echo "⚙️  Composer tidak ditemukan. Mengunduh..."
    curl -sS https://getcomposer.org/installer | php
    mv composer.phar /usr/local/bin/composer
fi
composer require asbiin/laravel-webauthn -W
composer install --no-dev --optimize-autoloader

# ========================================
# Bersihkan cache
# ========================================
echo "🧹 [8/10] Clear cache..."
php artisan optimize:clear

# ========================================
# Migrasi database
# ========================================
echo "📂 [9/10] Migrasi database..."
php artisan migrate --seed --force

# ========================================
# Permission + queue
# ========================================
echo "🔐 [10/10] Set permission & restart queue..."
...
# ========================================
# Bersihkan akses MySQL otomatis
# ========================================
rm -f ~/.my.cnf
